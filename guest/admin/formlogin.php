...
<html>
	...
	<title>Katanya Kue - Admin Login Page</title>
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li><a>||</a></li>						
						<li class="active"><a href="formlogin.php">Login</a></li>
					</ul>	
				</div>
			</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">Silahkan Masuk (Admin)</h3>
											...
											<form action="http://localhost/Katanya_Kue/guest/index.php">
												<div class="row form-group">
													<div class="col-md-12">
														<input type="submit" class="btn btn-primary btn-block" value="Back to Guest">
													</div>
												</div>
											</form>											
										</div>
